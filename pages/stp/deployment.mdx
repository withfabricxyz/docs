...
Some cannot change after deployment. Ensure these are set correctly before deploying.
...
<Tabs items={['sdk']}>
  ...
  const params: DeployParams = {
    ...
    initParams: {
      ...
      erc20TokenAddr: zeroAddress, // The address of the ERC20 token to use for minting (0x0 for native token, ETH)
