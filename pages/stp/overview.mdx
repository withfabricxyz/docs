...
Users must have an active subscription in order to withdraw their rewards. If their subscription lapses and they do not resubscribe, their rewards can be slashed (there is a grace period equal to 50% of total subscription time. eg a 6 month subscription will have a 3 month grace period).
