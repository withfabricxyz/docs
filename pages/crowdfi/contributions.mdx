...
4. The contribution amount doesn't violate the min and max contribution amounts for the contributing address
...
<Callout type="warning" emoji="⚠️">
  If an address attempts to contribute a value outside the range, the transaction will revert
</Callout>
