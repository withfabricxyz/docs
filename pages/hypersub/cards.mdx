...
- Card subscribers can receive [referral rewards](https://docs.withfabric.xyz/hypersub/subscribe#referral-rewards)
...
- Creators can only increase the price by 50% per year, once subscribers are active
