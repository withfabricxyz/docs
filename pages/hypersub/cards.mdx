...
<iframe width="100%" height="100%" src="https://www.youtube.com/embed/9EfjanYjcv0?rel=0&enablejsapi=1" title="Enable Card Payments" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
Paying with card on Hypersub is different than paying with crypto:
...
- Card payments renew automatically, on a recurring basis
- Members paying with card are not eligible for [Rewards](https://docs.withfabric.xyz/hypersub/rewards)
- Members paying with card can receive [referral rewards](https://docs.withfabric.xyz/hypersub/join#referral-rewards)
- Payouts are in fiat and occur through your Stripe dashboard
...
Once Stripe setup is complete you can enable card payments.

1. Go to the Settings tab of your Hypersub Dashboard
2. Click the Enable button, confirm and sign the transaction.

### Pricing

Set tier pricing after enabling card payments. **Important:** you must set card prices before accepting card payments.

1. After enabling card payments, click the Update tier pricing button
2. Turn on each tier and compare crypto prices
3. Enter card prices and confirm

Pricing limitations include:
...
Card prices can be changed any time: 

1. Go to the Settings tab of your Hypersub Dashboard and click the Update tier pricing button
2. Enter your new prices and confirm

Members are notified each time you change card pricing and are given the option to cancel their membership.

### Members

Card members will still need a connected wallet. Card payments are simply an additional way to pay. Benefits determined by your membership token will not be effected by members who pay with card.
