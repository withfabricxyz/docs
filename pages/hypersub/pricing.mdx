...
Simple is better, limit the number of tiers to avoid overwhelming subscribers. A good reason for tiers is when you have a wide range of offerings to bundle together. Learn more about [tiers](https://docs.withfabric.xyz/hypersub/tiers).
