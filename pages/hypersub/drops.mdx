...
Drops can deliver NFTs directly to your subscribers. To get started you will need to create an external mint page. This is where NFTs you drop originate from.
...
From your subscription page select the drops tab at the top of the page. Next use the create button at the top left of the page to open the dialog. Enter the url of your mint page, which populates the rest of the form.
...
Review and confirm to open your wallet and sign the transaction. Airdrops require no action from subscribers to receive NFTs.
