...
To get started, visit your subscription page and click the edit button above the title. These tools are powerful, and it should be noted that not all combinations are intended, or possible.
...
By default, your Hypersub theme is generated based on the colors in your artwork. Set a custom theme by editing the foreground and background colors. Here's a [handy tool](https://g.co/kgs/NdxYFha) for finding the hexadecimal color values.
