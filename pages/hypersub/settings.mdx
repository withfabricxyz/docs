...
This section details the more specific ways to use your Hypersub. To access these settings you must have deployed a Hypersub. Visit your subscription page and use the Edit button above the title. These tools are powerful, and it should be noted that not all combinations are intended, or possible.
...
Change theme to better suit your subscription over time. Some color combinations are better than others, always use high contrasting colors on your subscription page.
...
Configure a start date, end date, or both for your Hypersub with subscription duration. Set the duration by switching it on and using either calendar icons to pick a date and time.
